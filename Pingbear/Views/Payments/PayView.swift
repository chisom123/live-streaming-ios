                    ...
                    if let hourUnlock = viewModel.products.first(where: { $0.productIdentifier == "one_hour_boost" }) {
                        Button(action: {
                            ...
                            HStack {
                                ...
                                ZStack {
                                    Circle()
                                        .stroke(selectedBoostIndex == 0 ? Color(hex: "#4169E1") : Color.white.opacity(0.3), lineWidth: 2)
                    ...
                    if let dayUnlock = viewModel.products.first(where: { $0.productIdentifier == "one_day_boost" }) {
                        Button(action: {
                            ...
                            HStack {
                                ...
                                ZStack {
                                    Circle()
                                        .stroke(selectedBoostIndex == 1 ? Color(hex: "#4169E1") : Color.white.opacity(0.3), lineWidth: 2)
                                        .frame(width: 20, height: 20)
                    ...
                    if let weekUnlock = viewModel.products.first(where: { $0.productIdentifier == "one_week_boost" }) {
                        Button(action: {
                            ...
                            HStack {
                                ...
                                ZStack {
                                    Circle()
                                        .stroke(selectedBoostIndex == 2 ? Color(hex: "#4169E1") : Color.white.opacity(0.3), lineWidth: 2)
                                        .frame(width: 20, height: 20)

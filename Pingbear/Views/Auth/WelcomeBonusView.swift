...
struct WelcomeBonusView: View {
    ...
    @State private var showingDemoFlow = false
    ...
    var body: some View {
            ...
            VStack(spacing: 0) {
                ...
                Button(action: {
                    Analytics.shared.trackTap(
                        elementId: "welcome_bonus_continue",
                        screenName: "welcome_bonus"
                    )
                    showingDemoFlow = true
        ...
        // ── Demo flow ─────────────────────────────────────────
        .fullScreenCover(isPresented: $showingDemoFlow) {
            DemoFlowView()
        }
    }
}

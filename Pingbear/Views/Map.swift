...
//                                    .font(.system(size: 25))
//
//                                Text("!") // MAKE IT SO THE MAX  NUMBER IS 99
//                                    .foregroundColor(Color(hex: "#fff")) // Set text color to white for contrast
//                                    .font(.system(size: 20, weight: .bold)) // Adjust font size and weight as needed
//                            }
//                        }
//                    }
//
